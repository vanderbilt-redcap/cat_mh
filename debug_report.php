...
// $records[2]->$rid_field = 'TESTKayley';
// $records[2]->$enroll_field = "03-11-2021";

$current_time = time() + 90 * 24 * 60 * 60;
$invites_due = [
...
$invitation_debug_messages = $module->sendInvitations(time());

echo "<pre>";
echo print_r($invites_due, true);
echo print_r($urls, true);
echo print_r($links, true);
echo "\$module->getKCATSequenceIndex('TEST') : " . $module->getKCATSequenceIndex('TEST') . "\n";
echo "\$module->getKCATSequenceIndex('3-month Interviews') : " . $module->getKCATSequenceIndex('3-month Interviews') . "\n";
echo "\$module->getKCATSequenceIndex('kcat2') : " . $module->getKCATSequenceIndex('kcat2') . "\n";

echo implode("\n", $invitation_debug_messages);
